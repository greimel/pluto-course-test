...
* $(@bind is_u2 CheckBox()) $$u(x_1, x_2) = x_1 + x_2 - \frac{1}{2} x_2^2$$
...
# ╔═╡ 9f69f668-2116-11eb-0d55-b5dc28790d35
dx1dp2 > 0

# ╔═╡ a3e9bd9a-2116-11eb-193a-5fe86161f211
dx1dp2 < 0

# ╔═╡ b2b9cf7c-2116-11eb-1e42-79253615cc9d
dx1dp2 == 0
