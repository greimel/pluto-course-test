...
# ╔═╡ 174c181a-2e71-4e3d-bbf2-22da21f4248b
begin
	using LaTeXStrings
...
# ╔═╡ b0c440e4-36e1-4777-8072-7d12e7383e71
using PlutoUI

# ╔═╡ f235a6c2-ed2b-4fa4-9d5a-62c384d02667
using CairoMakie

# ╔═╡ aa06b93a-16b2-11eb-1574-8f97db9eeb12
md"""This notebook was used in tutorial 1A of *Microeconomics for AE* at the University of Amsterdam. There are two versions of this notebook using two different  *Julia* plotting packages.

At the time of this writing both packages have their problems when interacting with *Pluto.jl* notebooks. The *Plots.jl* version cannot show `surface` plots, the *Makie.jl* version needs a development branch of *CairoMakie.jl* for `surface` plots.
...
begin 
	x_grid = LinRange(-2, 2, 200)
	y_grid = LinRange(-2, 2, 200)
end;
...
md"Now, we can visualize the function using the *Makie* ecosystem in Julia."
...
begin
	...
	ax = Axis(fig[1,1])
	#scn = Scene()
	#heatmap!(scn, x_grid, y_grid, z_grid, colormap=cgrad(:viridis, 10, categorical=true), interpolate=true)
	contour!(ax, x_grid, y_grid, z_grid, levels = 9, color=:black, labels=true)
...
surface(x_grid, y_grid, z_grid, axis = (; type=Axis3))

# ╔═╡ dd76fbc4-16b0-11eb-3f71-755bfceafd62
md"Plotting a `heatmap` of $f$."

# ╔═╡ 7b0d2356-16af-11eb-26f4-3720209602e0
heatmap(x_grid, y_grid, z_grid)

# ╔═╡ bf49609a-0f92-47e0-baa6-1aa6758bfffa
md"""
# Appendix
"""

# ╔═╡ 64a7d5fd-c459-4dda-b13c-616614950dcc
TableOfContents()
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "b6aedc7734377aa6acdc966afade5b90ce7e8231"
