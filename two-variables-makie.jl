...
begin
	...
	pkg"add https://github.com/ffreyer/CairoMakie.jl#mesh3D"
	#Pkg.add("WGLMakie") #NOTE: replace by WGLMakie eventually to get interactivity
...
# ╔═╡ 6dcc8204-16af-11eb-3993-c9ecdc7b6463
...
begin
	...
	contour!(scn, x_grid, y_grid, z_grid, levels = 9, color=:black)
end
