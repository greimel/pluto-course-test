...
# ╔═╡ 888f01f2-b292-478d-a8f2-88fbd855c259
using PlutoUI
...
f_fix_y₀z₀(x₀), f_fix_x₀z₀(y₀), f_fix_x₀y₀(z₀), f(x₀, y₀, z₀)
...
begin
	f_x = derivative(f_fix_y₀z₀, x₀)
	f_y = derivative(f_fix_x₀z₀, y₀)
	f_z = derivative(f_fix_x₀y₀,  z₀)
...
begin
	...
	surface(x_grid, y_grid, ∂_grid, axis = (; type = Axis3)) |> as_svg
end

# ╔═╡ debc5e2c-1776-11eb-20b9-ab19e1caca8f
md"## Appendix"

# ╔═╡ 342b2613-e3b1-4efd-9b3e-9d5e0557115a
TableOfContents()
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "238ccfc30f4402bdc0ab6b31785b47cec8c7d3a8"
