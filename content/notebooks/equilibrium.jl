...
# ╔═╡ 290e5032-2d69-40ec-bf76-23086ebb9e54
using CairoMakie

# ╔═╡ e9422258-0720-4a09-8a82-cf38e0d7e2c8
using PlutoUI

# ╔═╡ ab3d70ee-6b3e-432d-ac1d-00f731825579
using PlutoUI: Slider

# ╔═╡ 564a76bb-d6e2-4527-9c71-4636aef4cf76
begin
	using Latexify
	using LaTeXStrings
...
md"""
Choose the number of firms ``N_O``: $(@bind Nₒ Slider(0:9, default = 6, show_value=true))

Choose the number of firms ``N_N``: $(@bind Nₙ Slider(0:9, default = 0, show_value=true))
"""
...
# ╔═╡ 0619d9cb-7895-4fd9-a8b5-a58e13fe6c8a
TableOfContents()
...
begin
	...
	ps = [p1, p2, p3]
	p_grid = p1 ∪ p2 ∪ p3 |> sort
end;

# ╔═╡ aaf3da80-28d7-11eb-2228-6b85433f5355
let
	fig = Figure()
	ax = Axis(fig[1,1], xlabel="quantity", ylabel="price")
	
	demand_label_tbd = true
	supply_label_tbd = true
	
	lines!(D.(p_grid), p_grid, label = "demand")
	...
	lines!(supply[1:i], p_grid[1:i], label = "supply")
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "2701bfd9e8d3e5ce40948fa0984ece6c7ccd2ceb"
